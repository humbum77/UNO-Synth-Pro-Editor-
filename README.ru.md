...
- **Библиотека пресетов без лимита в 256 ячеек.** Работает со стандартными файлами пресетов `*.unosyp`, но добавляет свои категории, теги и поиск по вложенным папкам — коллекция не ограничена ячейками памяти устройства.
